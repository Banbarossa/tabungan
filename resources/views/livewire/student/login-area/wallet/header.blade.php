<div>
    <div class="wallet-gradient px-4 pt-12 pb-0 relative overflow-hidden">
        ...
        <div class="flex items-center justify-between mb-5 relative">
            ...
            <h1 class="font-display font-bold text-white text-base">Uang Saku</h1>
        ...
        <div class="text-center pb-5 relative">
            ...
            <div class="flex items-center justify-center gap-3">
                <p class="font-display  text-white tracking-tight text-sm"> Limit Harian:
                    {{ data_get($data, 'limit') }}
                </p>
                <span class="rounded-lg border-red-50">
                    <flux:modal.trigger name="edit-profile">
                        <button class="">
                            <flux:icon name="pencil-square" class="size-5 text-yellow-500 hover:text-yellow-400" />
                        </button>
                    </flux:modal.trigger>
                    <livewire:student.login-area.wallet.modal-limit text_color="text-yellow-400" />
                </span>
            </div>
